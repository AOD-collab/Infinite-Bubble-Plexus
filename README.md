...
The Concept
In this model, any given system (The Plexus) is composed of connection points. However, these points are not static; each one is a "Bubble" that contains an entirely new, nested plexus within it. This recursion can continue infinitely.
